...
INSERT INTO market.tbl_products (product_title, product_description, product_price, product_count, product_group_id)
VALUES
  ('Product 1', 'Some description of a product 1', '500', '9000', '1'),
  ('Product 2', 'Some description of a product 2', '20', '900',   '2'),
  ('Product 3', 'Some description of a product 3', '330', '70',   '3'),
  ('Product 4', 'Some description of a product 4', '540', '810',  '4'),
  ('Product 5', 'Some description of a product 5', '30', '21',    '2'),
  ('Product 6', 'Some description of a product 6', '9000', '300', '3');
